...
import 'package:html_editor_enhanced/src/core/extensions/widget_context.dart';
                      ...
                      return Localizations(
                        ...
                        child: PointerInterceptor(
                          child: StatefulBuilder(builder:
                              (BuildContext context, StateSetter setState) {
                            return AlertDialog(
                              title: Text(context.language.insertImage),
                              scrollable: true,
                              content: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  ...
                                  children: [
                                    if (widget
                                      ...
                                      Text(context.language.selectFromFiles,
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold)),
                                    if (widget
                                        .htmlToolbarOptions.allowImagePicking)
                                    ...
                                    if (filename.text.isEmpty &&
                                      ...
                                      setState(() {
                                        validateFailed = widget
                                                .htmlToolbarOptions
                                                .allowImagePicking
                                            ? context.language.chooseImageOrUrl
                                            : context.language.enterImageUrl;
                                      });
                                    } else if (filename.text.isNotEmpty &&
                                        url.text.isNotEmpty) {
                                      setState(() {
                                        validateFailed =
                                            context.language.eitherImageOrUrl;
                                      });
                                    } else if (filename.text.isNotEmpty &&
